...
export default function AutomotiveCarDealershipNewT1({ data }: TemplateProps) {
      ...
      <section className="relative pt-40 pb-24 lg:pt-52 lg:pb-36 bg-[#0F172A] overflow-hidden">
        ...
        <div className="max-w-[90rem] mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              Drive your dream. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#60A5FA] to-[#2563EB]">Experience performance.</span>
            </motion.h1>
          ...
          <div className="lg:col-span-5 relative">
            <motion.div initial={{ opacity: 0, scale: 0.9, x: 50 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="relative grid grid-cols-2 gap-4">
              ...
              <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-slate-800 border-4 border-[#0F172A] z-10 shadow-2xl translate-y-8">
                <img 
                  src={getImg("https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=800&q=80", 0, data?.image)} 
                  alt="Sports Car" 
              ...
              <div className="space-y-4">
                <div className="relative rounded-[2rem] overflow-hidden aspect-square bg-slate-800 border-4 border-[#0F172A] z-10 shadow-2xl">
                  <img 
                    src={getImg("https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?w=600&q=80", 1)} 
                    alt="Luxury Car" 
                    className="w-full h-full object-cover transition-all duration-1000 scale-105 hover:scale-100" 
                  />
                </div>
                <div className="relative rounded-[2rem] overflow-hidden aspect-square bg-slate-800 border-4 border-[#0F172A] z-10 shadow-2xl">
                  <img 
                    src={getImg("https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&q=80", 2)} 
                    alt="Performance Car" 
                    className="w-full h-full object-cover transition-all duration-1000 scale-105 hover:scale-100" 
                  />
                </div>
