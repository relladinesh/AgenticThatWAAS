...
export default function FinanceAndProfessionalServicesCharteredAccountantFirmT1({ data }: TemplateProps) {
        ...
        <div className="max-w-[90rem] mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#60A5FA] to-[#2563EB]">Delivering value.</span>
            </motion.h1>
          ...
          <div className="lg:col-span-5 relative">
            <motion.div initial={{ opacity: 0, scale: 0.9, rotate: -2 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="relative">
              <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-tr from-[#2563EB] to-transparent opacity-20 blur-2xl"></div>
              <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-slate-800 border-4 border-[#0F172A] z-10 shadow-2xl">
                <img 
                  src={getImg("https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&q=80", 0, data?.image)} 
