  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      <nav className="border-b border-slate-100 py-6 px-10 flex justify-between items-center bg-white/80 backdrop-blur-md sticky top-0 z-10">
        <div className="font-semibold text-2xl tracking-tight">Restaurant / Dine-in</div>
      ...
      <div className="max-w-7xl mx-auto px-10 pt-24 pb-12">
        <header className="mb-32 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl font-light tracking-tight mb-8 leading-tight">Premium Template for <br/><span className="font-semibold text-indigo-600">Restaurant / Dine-in</span></h1>
